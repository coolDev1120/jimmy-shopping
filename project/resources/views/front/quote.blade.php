                    ...
                    <div class="edit-info-area">
                        ...
                        <div class="body">
                            <div class="edit-info-area-form">
                                ...
                                <form id="userform" action="{{route('user-quote-upload')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="customer_email" type="email" class="input-field" placeholder="Input your email address"  value="{{ Auth::check()? Auth::user()->email : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-sm-12 col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="customer_phone" type="text" class="input-field" placeholder="Input your phone number"   value="{{ Auth::check()? Auth::user()->phone : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input name="customer_name" type="text" class="input-field" placeholder="Input your name"  value="{{ Auth::check()? Auth::user()->name : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-sm-12 col-12">
