									...
									<div class="content">
										...
										<div class="billing-address">
											...
											<div class="row">
												...
												<input type="hidden" name="weight" value="{{ Session::has('cart') ? Session::get('cart')->totalWeight : '0' }}">
											</div>
										</div>
					...
					<div class="right-area">
						...
						<ul class="order-list">
							...
							<li>
								...
								<P>
									<b class="cart-total">{{ App\Models\Product::convertPrice($shipping_fee) }} </b>
								</P>								
							</li>
