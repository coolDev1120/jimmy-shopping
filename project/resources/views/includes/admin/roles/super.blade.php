    ...
    <li>
        <a href="{{ route('admin-daily-report') }}"><i class="icofont-calculator-alt-2"></i>
            <span>{{ __('Orders Report') }}</span></a>
    </li>

    <li>
        <a href="{{ route('admin-quotes') }}"><i class="icofont-cart"></i> <span>{{ __('Quotes') }}</span></a>
    </li>
    ...
    <li>
        <a href="{{ route('admin-role-index') }}" class=" wave-effect">
            <i class="fas fa-user-tag"></i>{{ __('Manage Roles') }}</a>
    </li>
    <li>
        <a href="{{ route('admin-role-index') }}" class=" wave-effect">
            <i class="fas fa-user-tag"></i>{{ __('Manage Teams') }}</a>
    </li>
    <li>
        <a href="{{ route('admin-cache-clear') }}" class=" wave-effect">
            <i class="fas fa-sync"></i>{{ __('Clear Cache') }}</a>
    </li>
    <li>
