...
@endif
    ...
    <li>
        <a href="#menu3" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-user"></i>{{ __('My Customers') }}
        </a>
        <ul class="collapse list-unstyled" id="menu3" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-agent-user-index') }}"><span>{{ __('My Customer List') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-agent-user-create') }}"><span>{{ __('Add new Customer') }}</span></a>
            </li>
        </ul>
    </li>
