...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        Route::get('/quotes', 'Admin\QuoteController@index')->name('admin-quotes');
        Route::get('/quotes/datatables', 'Admin\QuoteController@datatables')->name('admin-quotes-datatables'); //JSON REQUEST
        ...
        Route::get('/quotes/status/{id1}/{id2}', 'Admin\QuoteController@status')->name('admin-quote-accept');
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        Route::get('/users/agent', 'Admin\AgentController@index')->name('admin-agent-user-index');
        Route::get('/users/agent/create', 'Admin\AgentController@create')->name('admin-agent-user-create');
        Route::get('/users/datatables/{id}', 'Admin\AgentController@datatables')->name('admin-agent-user-datatables'); //JSON REQUEST
        Route::post('/users/agent/create', 'Admin\AgentController@create_user')->name('admin-user-create');

    });

    Route::group(['middleware' => 'permissions:sales_report'], function () {

        Route::get('/orders_report', 'Admin\SalesController@daily')->name('admin-daily-report');
...
// ************************************ API SECTION **********************************************
    ...
    Route::get('/api/get_all_orders', 'Front\ApiController@get_all_orders')->middleware('cors');;
    Route::get('/api/get_order_details/{id}', 'Front\ApiController@get_order_details')->middleware('cors');;
...
// ************************************ FRONT SECTION **********************************************
    ...
    // Quote Section
    Route::get('/quote', 'Front\QuoteController@index')->name('front.quote');
    Route::post('/quote', 'Front\QuoteController@quote')->name('user-quote-upload');
