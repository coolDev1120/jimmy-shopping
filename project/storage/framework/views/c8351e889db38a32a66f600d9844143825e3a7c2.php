	...
	<div class="mainmenu-area mainmenu-bb">
		<div class="container">
			<div class="row mainmenu-area-innner">
				<div id="category_total" class="col-lg-2 col-md-6 col-6">
				...
				<div id="category_us" class="col-lg-2 col-md-6 col-6 ">
					<!--categorie menu start-->
					<div class="categories_menu">
						<div class="categories_title">
							<h2 class="categori_toggle"><i class="fa fa-bars"></i>  US Market <i class="fa fa-angle-down arrow-down"></i></h2>
						</div>
						<div class="categories_menu_inner">
							<ul>
								<?php
								$i=1;
								?>
								<?php $__currentLoopData = $categories_us; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div id="category_vietnam" class="col-lg-2 col-md-6 col-6 ">
					<!--categorie menu start-->
					<div class="categories_menu">
						<div class="categories_title">
							<h2 class="categori_toggle"><i class="fa fa-bars"></i>  Vietnam <i class="fa fa-angle-down arrow-down"></i></h2>
						</div>
						<div class="categories_menu_inner">
							<ul>
								<?php
								$i=1;
								?>
								<?php $__currentLoopData = $categories_vietnam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
