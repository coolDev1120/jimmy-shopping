    ...
    <li>
        <a href="<?php echo e(route('admin-daily-report')); ?>"><i class="icofont-calculator-alt-2"></i>
            <span><?php echo e(__('Orders Report')); ?></span></a>
    </li>

    <li>
        <a href="<?php echo e(route('admin-quotes')); ?>"><i class="icofont-cart"></i> <span><?php echo e(__('Quotes')); ?></span></a>
    </li>
    ...
    <li>
        <a href="<?php echo e(route('admin-role-index')); ?>" class=" wave-effect">
            <i class="fas fa-user-tag"></i><?php echo e(__('Manage Roles')); ?></a>
    </li>
    <li>
        <a href="<?php echo e(route('admin-role-index')); ?>" class=" wave-effect">
            <i class="fas fa-user-tag"></i><?php echo e(__('Manage Teams')); ?></a>
    </li>
    <li>
        <a href="<?php echo e(route('admin-cache-clear')); ?>" class=" wave-effect">
            <i class="fas fa-sync"></i><?php echo e(__('Clear Cache')); ?></a>
    </li>
    <li>
