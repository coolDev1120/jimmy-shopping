				...
				<i class="icofont-upload-alt"></i> <?php echo e(__('Upload Image Here')); ?>
						                    ...
						                    <div class="showbox">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" type="number" class="input-field" placeholder="<?php echo e(__('e.g 20')); ?>" step="0.01" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="0.01" type="number" class="input-field" placeholder="<?php echo e(__('e.g 20')); ?>" min="0">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading"><?php echo e(__('Product Weight')); ?>*</h4>
															<p class="sub-heading"><?php echo e(__('(lbs)')); ?></p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="weight" step="0.01" type="number" class="input-field" placeholder="<?php echo e(__('e.g 1')); ?>" min="0">
													</div>
												</div>
