                ...
                <div class="col-lg-12">
                    <ul class="pages">
                        ...
                        <?php if(!empty($childcat)): ?>
                            <li>
                                <a
                                    href="<?php echo e(route('front.category', [$cat->slug, $subcat->slug, $childcat->slug])); ?>"><?php echo e($childcat->name); ?></a>
                            </li>
                        <?php endif; ?>
                    ...
                    <div class="right-area" id="app">
                        ...
                        <div class="categori-item-area">
                            ...
                            <div id="ajaxLoader" class="ajax-loader"
                                style="background: url(<?php echo e(asset('assets/images/' . $gs->loader)); ?>) no-repeat scroll center center rgba(0,0,0,.6);">
                            </div>
                        </div>
    ...
    <script>
        ...
        function addToPagination() {
            ...
            $('ul.pagination li a').each(function() {
                ...
                let fullUrl =
                    '<?php echo e(route('front.category', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')])); ?>?page=' +
                    page + '&search=' + '<?php echo e(request()->input('search')); ?>';
        ...
        $(function() {
            ...
            $("#slider-range").slider({
                ...
                values: [<?php echo e(isset($_GET['min']) ? $_GET['min'] : '0'); ?>,
                    <?php echo e(isset($_GET['max']) ? $_GET['max'] : '10000000'); ?>
