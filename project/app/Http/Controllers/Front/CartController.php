...
class CartController extends Controller
{
   ...
   public function addtocart($id)
    {
        $prod = Product::where('id','=',$id)->first(['id','user_id','weight','slug','name','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
        ...
        foreach($cart->items as $data)
        {
            ...
            $cart->totalWeight += (float)$data['item']['weight'];
        }
