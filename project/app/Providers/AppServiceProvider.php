...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('*',function($settings){
            ...
            $settings->with('categories', Category::all());
            $settings->with('categories_us', Category::where('status','=',1)->get());  
            $settings->with('categories_vietnam', Category::where('status','=',0)->get());  
