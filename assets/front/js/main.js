$(function ($) {
    ...
    $("#category_total .categories_title").on("mouseover", function() {
        $(this).addClass('active');
        $('#category_total .categories_menu_inner').stop().slideDown('medium');
    }); 

    $("#category_us .categories_title").on("mouseover", function() {
        $(this).addClass('active');
        $('#category_us .categories_menu_inner').stop().slideDown('medium');
    }); 

    $("#category_vietnam .categories_title").on("mouseover", function() {
        $(this).addClass('active');
        $('#category_vietnam .categories_menu_inner').stop().slideDown('medium');
    }); 
  ...
  $(document).on('mouseover', function(e) 
  {
     ...
     /*------addClass/removeClass categories-------*/
        ...
        if(w <= 991)
        {
            $("#category_total .categories_title").on("click", function() {
                $(this).toggleClass('active');
                $('#category_total .categories_menu_inner').stop().slideToggle('medium');
            }); 

            $("#category_us .categories_title").on("click", function() {
                $(this).toggleClass('active');
                $('#category_us .categories_menu_inner').stop().slideToggle('medium');
            }); 

            $("#category_vietnam .categories_title").on("click", function() {
                $(this).toggleClass('active');
                $('#category_vietnam .categories_menu_inner').stop().slideToggle('medium');
            }); 
